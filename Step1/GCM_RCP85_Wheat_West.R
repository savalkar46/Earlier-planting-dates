...
## write_csv(df, paste0("/weka/data/project/agaid/supriya/Planting_Date/Future/West_US/RCP85/Wheat/",state,".csv"))
saveRDS(df, paste0("/weka/data/project/agaid/supriya/Planting_Date/Future/West_US/RCP85/Wheat/",state,".rds"))
