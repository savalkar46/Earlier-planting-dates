...
## lat_lon_csv <- read.csv("/home/supriya.savalkar/Planting_Date/Scripts/East_Grid_List1.csv")
...
## write_csv(df, paste0("/weka/data/project/agaid/supriya/Planting_Date/Future/RCP85/Wheat/",state,".csv"))
saveRDS(df, paste0("/weka/data/project/agaid/supriya/Planting_Date/Future/RCP85/Wheat/",state,".rds"))
