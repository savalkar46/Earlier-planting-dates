...
#SBATCH --job-name=Wheat_RCP85_OL_2065_2095 # Job Name
...
Rscript --vanilla /home/supriya.savalkar/Planting_Date/Extract_Scripts/Extract_July2023/Wheat_RCP85_OL_2065_2095.R