...
Wheat <- list.files("/weka/data/project/agaid/supriya/Planting_Date/Future/Historical/Wheat")
Path <- "/weka/data/project/agaid/supriya/Planting_Date/Future/Historical/Wheat"
Masterfile <- rep()
i=1
length(Wheat)
...
saveRDS(Masterfile, paste0("/weka/data/project/agaid/supriya/Planting_Date/Extracted/Wheat_Historic_V02.rds"))
